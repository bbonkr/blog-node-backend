...
export class TagsController extends ControllerBase {
     ...
     * @param next
     */
    private async getTags(req: Request, res: Response, next: NextFunction): Promise<any> {
        const thisRef = this;

        try {
            const limit: number = (req.query.limit && parseInt(req.query.limit, 10)) || 10;
     ...
     * @param next
     */
    private async getPosts(req: Request, res: Response, next: NextFunction): Promise<any> {
        try {
