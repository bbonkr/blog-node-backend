...
export enum HttpStateCodeCategory {
    ...
    CATEGORY_SUCCESSFUL = 'Successful',
}

export interface HttpStatus {
    code: number;
    status: string;
    category: HttpStateCodeCategory;
    description?: string;
}
...
export const httpStatus: Dictionary<HttpStatus> = {
    http100: {
        code: 100,
        status: 'Continue',
        category: HttpStateCodeCategory.CATEGORY_INFORMATION,
        description:
    ...
    http200: {
        code: 200,
        status: 'OK',
        category: HttpStateCodeCategory.CATEGORY_SUCCESSFUL,
